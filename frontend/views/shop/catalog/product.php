...
$this->title = $product->meta->title ? $product->meta->title : $product->name;
...
<div class="row" xmlns:fb="http://www.w3.org/1999/xhtml">
    ...
    <div class="col-sm-4">
        <p class="btn-group">
            <button type="button" data-toggle="tooltip" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add(<?=$product->id?>)"><i class="fa fa-heart"></i></button>
