...
class m180104_124200_add_shop_product_main_photo_field extends Migration
{
    public function up()
    {
        ...
        //При удалении такой фотографии из базы - проставить в main_photo_id значение NULL
        //При обновлении такой фотографии из базы - ничего не делать(RESTRICT) со значением в main_photo_id
    ...
    public function down()
    {
        ...
        $this->dropIndex('{{%fk-shop_products-main_photo_id}}', '{{%shop_products}}');
